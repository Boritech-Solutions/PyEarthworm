...
#--------------------------------------------------------------------
 ...
 Installation   INST_OAVV        186   # Observatorio Argentino de Vigilancia Volc�nica (OAVV), Servicio Geol�gico Minero Argentino (SEGEMAR), Argentina
 Installation   INST_SMU         187   # Soufriere Monitoring Unit, Ministry of Agriculture, Kingstown, St Vincent 
 Installation   INST_CGEO        188   # Centro de Geociencias, UNAM, Queretaro
 Installation   INST_SVG         189   # SVG (Servicio Vulcanol�gico de Guatemala), Univ. Mariano Galvez de Guatemala
 Installation   INST_SSG         190   # SVG (Servicio Sismol�gico de Guatemala), Univ. Mariano Galvez de Guatemala
 Installation   INST_JNU         191   # Chonnam National University (JNU), South Korea

# NEXT  placemark for easy search to end of ID list
...
#Message  TYPE_STRONGMOTION     27  # single-instrument peak accel, peak velocity,
 ...
 Message  TYPE_MSEED3           37  # Miniseed3 data record
